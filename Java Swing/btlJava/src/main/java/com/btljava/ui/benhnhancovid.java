 ...
 * @author ASUS
 */
public class benhnhancovid extends javax.swing.JDialog {
    private DefaultTableModel model;
    int ids = 0;
    private BenhNhanController dao = new BenhNhanController();
    
    /**
     * Creates new form benhnhancovid
     */
    public benhnhancovid(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
...
//            benhnhanDao dao = new benhnhanDao();
            List<benhnhan> list = dao.banhnhancovid19();
            model.setRowCount(0);
...
//            benhnhanDao dao = new benhnhanDao();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Bệnh nhân mắc Covid-19");
...
//                benhnhanDao dao = new benhnhanDao();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(benhnhancovid.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                benhnhancovid dialog = new benhnhancovid(new javax.swing.JFrame(), true);
