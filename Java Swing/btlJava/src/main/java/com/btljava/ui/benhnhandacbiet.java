 ...
 * @author ASUS
 */
public class benhnhandacbiet extends javax.swing.JDialog {
    private DefaultTableModel model;
    int ids = 0;
    private BenhNhanController dao = new BenhNhanController();
    
    /**
     * Creates new form benhnhandacbiet
     */
    public benhnhandacbiet(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
...
//            benhnhanDao dao = new benhnhanDao();
            List<benhnhan> list = dao.benhnhandacbiet();
            model.setRowCount(0);
...
//            benhnhanDao dao = new benhnhanDao();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Bệnh nhân đặc biệt");
...
//                benhnhanDao dao = new benhnhanDao();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(benhnhandacbiet.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                benhnhandacbiet dialog = new benhnhandacbiet(new javax.swing.JFrame(), true);
