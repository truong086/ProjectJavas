 ...
 * @author ASUS
 */
public class benhnhanss extends javax.swing.JDialog {
    private fromMain mains;
    int ids = 0;
    private DefaultTableModel model;
    
    private BenhNhanController dao = new BenhNhanController();
    private TaiKhoanController daoss = new TaiKhoanController();
    private NhanVienController daonv = new NhanVienController();
    
    /**
     * Creates new form benhnhanss
     */
    public benhnhanss(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//            benhnhanDao dao = new benhnhanDao();
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        try{
            ...
            tk.setTentaikhoan(mabenhnhan);
            tk.setMatkhau(mabenhnhans.getText());
            tk.setPhanquyen(3);
...
//            nhanvienDao daonv = new nhanvienDao();
            nhanvien nvd = daonv.findby(mabenhnhans.getText());
            if(nvd != null){
                MessageDialog.showMessageError(this, "Thông tin này bên bảng nhân viên đã tồn tại", "Lỗi");
                return;
            }
...
//                taikhoanDao daoss = new taikhoanDao();
                String tentaikhoant = String.valueOf(mabenhnhans.getText());
                daoss.deleteName(tentaikhoant);
                loadDatatable();
            }else{
                MessageDialog.showMessageError(mains, "Đã có lỗi xảy ra", "Lỗi");
            }
...
//            benhnhanDao dao = new benhnhanDao();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(benhnhanss.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                benhnhanss dialog = new benhnhanss(new javax.swing.JFrame(), true);
